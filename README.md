...
## Add the layers by specifying the number of neurons and the activation function used, You cna do this using model = Model(), model.add_layer(Linear(784, 128)), model.add_layer(ReLU())
